...
function WorkingWithArrays() {
  ...
  return (
    <div>
      ...
      <input value={todo.id} className="form-control" readOnly />
      <input
      ...
      <br />
      <button className="btn btn-primary mb-2 " onClick={postTodo}>
        Post Todo
      </button>
        ...
        {todos.map((todo) => (
          <li key={todo.id} className="list-group-item">
            <button
              ...
              className="btn btn-warning ms-2  me-2 float-end"
            >
              Edit
            </button>
            <button
